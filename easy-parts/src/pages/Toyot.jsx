  ...
  return (
    <div>
         <div className="kolodca hover:scale-[1.1] duration-[.5s]  gap-6 items-center bg-[#E9F7F7] py-2 px-3 mb-5 cursor-pointer">
          ...
          <div className="sveci">
            <p className='font-bold w-[80%] mb-3  hover:text-[#1FAFAC] hover:text duration-[.3s]   '>Колодки тормозные дисковые</p>
          <div className="d">
              <p className=' flex'> <Stars stars={random}/> </p>
          </div>
            <div className="korzin flex items-center mb-2 mt-3 justify-between">
            <h1 className="  font-semibold text-2xl pt-5  hover:text-[#1FAFAC] hover:text duration-[.3s]   ">{item.price}</h1>
