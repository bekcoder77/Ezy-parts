  ...
  return (
    <div>
       ...
       <div className="container_div flex my-10 pb-16">
            ...
            <div className="right">
                <h1 className='text-5xl px-5 text-[#333333] pt-20 font-[500] w-[90%]'>Моторное масло GAZPROMNEFT Super 10W-40 5л</h1>
                ...
                <p className='text-3xl font-bold ml-5 text-[#333333]'>16 385 ₸</p>
       ...
       <div className="btns">
       <div className="buttons flex mt-5 gap-4 ml-5 justify-center">
              <button className="btn hover:border-[#E11C43] border-2 duration-[.3s] text-[#333333]  rounded-md  text-center w-[280px]  py-2">
              Продавцы
              </button>
              <button className="btn  duration-[.3s] hover:bg-[#18A7A7] hover:text-[#ffff] rounded-md text-[#333333] border-2 text-center  w-[280px]   py-2">
              Отзывы
              </button>
              <button className="btn  duration-[.3s] hover:bg-[#18A7A7] hover:text-[#ffff] rounded-md text-[#333333] border-2 text-center  w-[280px]   py-2">
              Характеристики
