...
<img className=' absolute top-[-70px] left-10' src="./assets/f-left.png" alt="" />
<img className=' absolute top-[-70px] left-0' src="./assets/tor.png" alt="" />
<img className=' absolute top-[10px] object-cover right-0' src="./assets/f-right.png" alt="" />
<img className=' absolute top-[-78px] object-cover right-0' src="./assets/tor-r.png" alt="" />

    </div>
   <div className="footer-links flex justify-between  px-16 py-14">
   <div className="links flex gap-[200px]  list-none cursor-pointer">
             <div className="left">
             <li className="link">Каталог автозапчастей</li>
    ...
    <div className="social flex gap-2 mt-[-60px]">
        <img className='w-[30px] object-contain' src="./assets/vk.png" alt="" />
        <img className='w-[30px] object-contain' src="./assets/ins.png" alt="" />
        <img className='w-[30px] object-contain' src="./assets/fs.png" alt="" />
    </div>
    <div className="logo">
   ...
   <p>Используя ezyparts.kz, вы принимаете условия использования сайта</p>
